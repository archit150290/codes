...
$(document).ready(function () {
    ...
    //================download complete spreadsheet of endorsement received and given
    $("#sasalllistings").click(function () {
        var headvalues = [];
        var resultant = [];
        $("#listingreportser table thead th").each(function () {
            headvalues.push($(this).text())
        });
        var spreadsheetobject = {};
        var i = 0, total;
        $("#listingreportser table tbody tr").each(function () {
            if ($(this).is(":visible") == true) {
                var abc = new Array();
                var tdlength = 1;
                $(this).children("td").each(function () {
        ...
        totaler = i;
        $("#listingreportseg table tbody tr").each(function () {
            if ($(this).is(":visible") == true) {
                var abc = new Array();
                var tdlength = 1;
                $(this).children("td").each(function () {
        ...
        var alldata = JSON.stringify(spreadsheetobject);
        var tableheader = JSON.stringify(headvalues);
        $.ajax({
            type: "POST",
            url: siteurl + 'ajax/downloadallendorsementlist',
            data: {alldata:alldata, totaler:totaler, tableheader:tableheader},
            success: function (data) {
