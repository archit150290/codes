...
//                }
                ...
                //===========end
                $pagefrommessage = 0;
                if($this->Session->read('messageforuser') && $this->Session->read('messageforuser')!= ""){
                    $pagefrommessage = $this->Session->read('messageforuser');
                    $this->Session->delete('messageforuser');
                }    
            }
        } else {
            $this->redirect(array('controller' => 'client', 'action' => 'login'));
        ...
        $this->set(compact("allexistinvalues", "optionsselected", "org_id", "alldetailsorg", "graphbycorevalues", "startdate", "enddate", "pagefrommessage"));
    }
