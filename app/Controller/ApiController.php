...
class ApiController extends AppController {
    ...
    var $uses = array("User", "ApiSession", "Department", "Organization", "UserOrganization", "Invite", "Email", "Entity", "OrgCoreValues",
        ...
        "Topendorser", "globalsettingFaq", "Emojis", "JoinOrgCode", "Post", "PostAttachment", "PostTrans", "PostLike", "PostComment", "FeedTran");
...
//}
        if ($model == "OrgJobTitles") {
            ...
            $fields = array("name", "allow_comments", "optional_comments", "allow_attachment");
        } else {
            $fields[] = "name";
            $title = "name";
        }
