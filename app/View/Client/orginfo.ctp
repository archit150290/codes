        ...
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <a href="javascript:void(0);" class="btn btn-orange pull-right modalmyrole" data-toggle="modal" data-target="#myModalroleinorg">My Role in This Org</a>
                </div>
            </div>
        </div>
...
<script>
    var pagefrommessage = '<?php echo $pagefrommessage; ?>';
    if (pagefrommessage!= 0) {
        alertbootboxcb(pagefrommessage, function(){
            $(".modalmyrole").trigger("click");
        });
    }
</script>
