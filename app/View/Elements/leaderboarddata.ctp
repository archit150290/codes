                ...
                ?>
                    ...
                    <thead id="scrollheader">
                        <tr id="">
                            ...
                            <th width="17%" align="center"  style="text-align:center"><?php echo ENDORSER;?></th>
                            <th width="17%" align="center" style="text-align:center">nDorsed</th>
                            <th width="18%" style="text-align:center">Total</th>
                            <th width="20%" style="text-align:center">Department</th>
                            <th width="14%" style="text-align:center; ">Sub Organization</th>
                        </tr>
                    </thead>
