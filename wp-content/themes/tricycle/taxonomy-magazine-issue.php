...
<div class='wrap'>
    ...
    <div class='landing-marquee magazine'>
        ...
        <main class='slider'>
            ...
            { 
                $addon_class = "arrow-off";
            } 
            ?>
            <div class='slider-next <?php echo $addon_class; ?>'>
            ...
            <header class='slider-date'>
                <time class='h2'><?php echo $tax_name; ?>
                    <span class='vol-no'>
                        <?php
                ...
                <p class="h2">
                <?php if($i == 0 || $i == 1){
                    if(isset($term_meta['buyissuelink']) && !empty($term_meta['buyissuelink'])){?>
