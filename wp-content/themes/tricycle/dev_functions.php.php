...
function get_tool_tip_sharethis($title, $url, $post_ID) {
    ...
    <div class = 'tools_top'>
        <ul>
            <li class="st_facebook_custom" st_title='<?php echo $title; ?>' st_url='<?php echo $url; ?>'><a class='icon icon-tools_facebook' href='javascript:void(0)' data-grunticon-embed></a></li>
            <li class="st_twitter_custom" st_title='<?php echo $title; ?>' st_url='<?php echo $url; ?>'><a class='icon icon-tools_twitter' href='javascript:void(0)' data-grunticon-embed></a></li>
    ...
    <div class='paywall'>
        <div class='paywall-body <?php echo $pageclass; ?>'>
            ...
            <form class='login-form' name='login' id="login_paywall" ref="<?php echo get_template_directory_uri(); ?>">
                ...
                <button class='button' type='submit' id="login-paywall-button">Login</button>
...
/* functions for ad management */
    ...
    function get_subscribe_module() {
        ...
        <div class="CTA-module_subscribe">
            ...
            <a href='https://subscribe.tricycle.com/TRI/?f=join' target="_blank" class="button">Subscribe now</a>
        </div>
        <?php
        }
    ...
    function get_dailydharma() {
        ...
        while ($querydharma->have_posts()):
            ...
            } ?>'><a class='icon icon-share_facebook' href='javascript:void(0)' data-grunticon-embed></a></li>
                                <li class="st_twitter_custom" st_title='<?php the_content(); ?>' st_url='<?php if (empty($dailydharma_url)) {
                    the_permalink();
                } else {
                    echo $dailydharma_url;
                } ?>'><a class='icon icon-share_twitter' href='javascript:void(0)' data-grunticon-embed></a></li>
                                <li class="st_email_custom" st_title='<?php the_content(); ?>' st_url='<?php if (empty($dailydharma_url)) {
                    the_permalink();
                } else {
                    echo $dailydharma_url;
                } ?>'><a class='icon icon-share_email' href='javascript:void(0)' data-grunticon-embed></a></li>
                </ul>
            </div>
                    <?php
                endwhile;
                ...
                <div class='modal-inner_paywall'>
                    ...
                    <div class='paywall-wrapper'>
                        <div class='paywall-body <?php echo $classname; ?>'>
                            ...
                            <a class='button' href='https://subscribe.tricycle.com/TRI/?f=join' target='_blank'>Subscribe Now</a>
                            <p>Already a subscriber? Log in.</p>
                            <form class='login-form' name='login' id="login_paywall_popup<?php echo $cntr; ?>" ref="<?php echo get_template_directory_uri(); ?>">
