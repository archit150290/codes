            ...
            while ($querydharma->have_posts()): 
                ...
                if($loop == 1)
                {
                    ...
                    <main>
                        <article>
                            <figure>
                                <div class='icon-video_play' rel='<?php echo $video; ?>' data-grunticon-embed></div>
                                <?php echo get_image_with_srcset(array("post_id"=>get_the_ID(), "image_type"=>"thumbnail", "source_width"=>array(2000, 1000, 500), "size"=>"image-size-500", "attr_sizes"=>"(min-width: 50em) 75vw,100vw")); ?>
                                <?php //echo srcset_post_thumbnail(get_the_ID(), 'image', '','(min-width: 50em) 75vw,100vw'); ?>
                ...
                if($queryfirst->have_posts())
                {
                    while ( $queryfirst->have_posts() ): 
                        ...
                        <article>
                            <figure>
                                <a href='<?php the_permalink(); ?>'>
                                    <?php echo get_image_with_srcset(array("post_id"=>get_the_ID(), "image_type"=>"thumbnail", "source_width"=>array(1000, 500), "size"=>"image-size-400", "attr_sizes"=>"(min-width: 60em) 33vw,(min-width: 50em) 40vw,(min-width: 37.5em) 50vw,(min-width: 25em) 75vw,100vw")); ?>
                ...
                if($results)
                {
                    ...
                    if($querydharma->have_posts())
                    {
                        while ( $querydharma->have_posts() ): 
                            ...
                            <article>
                                <figure>
                                    <div class='icon-video_play' rel="<?php echo get_post_meta(get_the_ID() ,'meta_type_filmfest_shorttrailer',true); ?>" data-grunticon-embed></div>
                                    <?php echo get_image_with_srcset(array("post_id"=>get_the_ID(), "image_type"=>"thumbnail", "source_width"=>array(2000, 1000, 500), "size"=>"image-size-500", "attr_sizes"=>"(min-width: 50em) 75vw,100vw")); ?>
                                    <?php //echo srcset_post_thumbnail(get_the_ID(), 'image', '','(min-width: 50em) 75vw,100vw'); ?>
            ...
            <main>
                ...
                if($querydharma->have_posts())
                {
                    while ( $querydharma->have_posts() ): 
                        ...
                        <article>
                            <figure>
                                <div class='icon-video_play' rel='<?php echo get_post_meta(get_the_ID() ,FILM_CLUB_META_POST_SHORT_TRAILER, true); ?>' data-grunticon-embed></div>
                                <?php echo get_image_with_srcset(array("post_id"=>get_the_ID(), "image_type"=>"thumbnail", "source_width"=>array(2000, 1000, 500), "size"=>"image-size-500", "attr_sizes"=>"(min-width: 50em) 75vw,100vw")); ?>
                                <?php //echo srcset_post_thumbnail(get_the_ID(), 'image', '','(min-width: 50em) 75vw,100vw'); ?>
                                <div class='video-wrapper'>
                                </div>
