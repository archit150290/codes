...
if(have_posts())
{
    while(have_posts())
    {
        ...
        $paywall_loginned = is_post_behind_paywall(get_the_ID()) ;
        ?>
        <script>
            var downloadpdf = "<?php echo get_site_url(); ?>/download.php?file=";	
        </script>
            ...
            <article class='article_dharmatalks dharmatalks'>
                ...
                <main class='article-main_dharmatalks'>
                    ...
                    <div class='article_playlist'>
                        <ol>
                            ...
                            for($i = 0; $i < $total_videos; $i++){
                                ...
                                <?php   if($videoList > 2 && empty($paywall_login) && $paywall_loginned==1){?>
                                            <li>
                                                ...
                                                <?php echo getpaywall_popup('dharmatalks','TK dharmatalk paywall copy!',$i);?>
                                            </li>
                                  <?php }else{?>
                                            <li>
                    ...
                    <div class='article-dharmatalk-title'>
                        ...
                        <?php 
                        if(empty($downloadPDF) && empty($video_name)){?>
                            <p class='transcript' style="display: none">
                                <a class='h2' id="pdf_download" href='<?php echo get_site_url(); ?>/download.php?file=<?php echo urlencode(base64_encode($downloadPDF)); ?>'>Download Transcript</a>It has been edited for clarity.
                            </p>
                        <?php }else{?>
                    ...
                    <div class="tools_top addtool">&nbsp;</div>
...
?>
        ...
        <script>
            ...
            var payWall = <?php echo $paywall_loginned;?>;
            //for getting most popular
        ...
        <script>
            ...
            jQuery( document ).ready(function() {
                ...
                if(videonumber <= "2"){
                    ...
                    if(pdf_video!=""){
                        var downloadlink = downloadpdf+window.btoa(pdf_video);
                    ...
                    jQuery('.icon-video_play').attr('rel',videosrc);
...
//                    $(dept + ' .video-wrapper').css('display', 'block');
                ...
                else if(videonumber > 2 && payWall == "0" ){   
                    $('.article-dharmatalk-title h1').text(videoTitle);
                    var dept = ".article-video_featured";
                    $('.article_playlist h1').removeClass('play');
                    $( 'a[ videonumber="'+videonumber+'"] h1' ).addClass( 'play' );
