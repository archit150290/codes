...
<html lang='en'>
    ...
    <body class="print">
        ...
        <div id="non_logged_in" style="display:none">
                        ...
                        <div class="copyright">Copyright 2015. Tricycle. All rights reserved.</div>
                        </div>
        </div>
        <!--End Of Div-->
                        ...
                        <main class='article-main_base'>
                            <div class='article-image_featured'>
                                ...
                                if (!empty($getbase_hero_image)) {
                                    ...
                                    echo get_image_with_srcset(array("post_id"=>$post_ID, "image_type"=>"hero_template_image", "source_width"=>array(2000, 1000, 500), "size"=>"image-size-500", "attr_sizes"=>"(min-width: 50em) 33vw, 100vw"));
                ...
                <main class='wrap_base'>
                    ...
                    <article class='article_dharmatalks dharmatalks'>
                        ...
                        <main class='article-main_film'>
                            <div class='article-image_featured'>
                                <figure>
                                    <?php echo get_image_with_srcset(array("post_id"=>$post_ID, "image_type"=>"thumbnail", "source_width"=>array(2000, 1000, 500), "size"=>"image-size-500", "attr_sizes"=>"(min-width: 60em) 75vw, 100vw")); ?>
                ...
                <div class='landing-marquee ebooks'>
                    ...
                    <main class='slider'>
                        ...
                        <figure class='slider-cover'>
                            <?php echo get_image_with_srcset(array("post_id"=>$post_ID, "image_type"=>"thumbnail", "source_width"=>array(800, 400), "size"=>"image-size-400", "attr_sizes"=>"(min-width: 60em) 33vw,(min-width: 37.5em) 50vw,75vw")); ?>
