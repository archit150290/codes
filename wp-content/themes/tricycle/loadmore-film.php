<?php
$location=$_SERVER['DOCUMENT_ROOT'].'/tricycle';
...
<?php if ($count > 3) { ?>
    <div class='more filmclub'> 
        <?php $url= get_template_directory_uri().'/loadmore-film.php'; ?>
        <?php $onclick = 'onclick=loadmoreajax("' . $searchYear . '","' . json_encode($postId) . '","' . $post_type . '","' . $url . '");' ?>
