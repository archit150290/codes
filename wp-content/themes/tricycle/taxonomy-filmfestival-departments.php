        ...
        <div class='landing-stack-1'>
            ...
            if (have_posts() && $countPost > 0) {
                ...
                while (have_posts()) {
                    ...
                    $topic_urls = $topics && isset($topics['names_with_urls']) ? implode(", ", $topics['names_with_urls']) : "";
                    $issues = get_issues_by_post_id($post->ID);
                    echo $issues_names_without_urls = $issues && isset($issues['names_without_urls']) ? implode(", ", $issues['names_without_urls']) : "";
                    ?>
                    <article class='<?php echo $post_type; ?>'>
                        <figure>
                            <a href='<?php the_permalink(); ?>'>
                    ...
                    if ($counter == 7 && $countPost > 0) {
                        ...
                        <div class="loader-more">
                            <div class='more'>
                                ...
                                <input type="hidden" name="taxonomy" id="taxonomy" value="<?php echo 'filmfestival-departments' ?>" />
