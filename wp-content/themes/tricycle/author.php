...
<!-- start content -->
<div class='wrap'>
    <?php echo $theme_root = get_site_url();?>
                ...
                <article class = '<?php echo $post_type; ?>' >
                    <figure>
                        <a href = '<?php the_permalink(); ?>'>
                            <?php
                            if ($post_type == DHARMATALKS_POST_TYPE || $post_type == FILM_CLUB_POST_TYPE || $post_type == FILM_FESTIVAL_POST_TYPE) {
                    ...
                    <section class = 'rubric <?php echo $post_type; ?>'>
                        ...
                        <h2 class = '<?php echo $post_type; ?>'><a href = '<?php echo $postTypeLink; ?>'><?php echo $postMenuName; ?></a>
