...
describe('General Test', function () {
    ...
    describe("constructor", function () {
        ...
        it("Test 4 should have a variant from array['a','b','c','d','e','f', 'g', 'h']", function () {
            expect(['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h']).to.include(ABalytics.variantName);
        });
        ...
        it("Test 6 should not have a variant from array['a','b','c','d','e','f','g', 'h']", function () {
    ...
    describe("Test Cases for H variant", function () {
        it('Test 33 variantID=5 means H', function () {
