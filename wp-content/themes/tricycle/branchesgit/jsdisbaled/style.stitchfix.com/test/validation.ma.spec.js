...
describe("Unit Testing Cases", function () {
    ...
    describe("Validate Functionality for form New User Form", function () {
        ...
        it('v1 Case When Only First Name is there and removed', function () {
        ...
        it('v2 Case When Only Last Name is there and removed', function () {
        ...
        it('v3 Case When Only Email is there and ajax call true', function (done) {
        ...
        it('v4 Case When Only Email is there and ajax call fails', function (done) {
            var post = sinon.stub($, 'ajax');
        ...
        it('v5 Case When wrong email domain is entered', function () {
        ...
        it('v6 Case When right email domain is entered but different one ', function () {
            $("#new_user #user_email").val("dugararchit@archit.actor")
            $("#new_user #user_email").blur();
            expect(objValidate.items["user_email"].status).to.be.true
        });

        it('v7 Case When email entered is not right', function () {
            $("#new_user #user_email").val("dugararchitgmail.com")
            $("#new_user #user_email").blur();
            expect(objValidate.items["user_email"].status).to.be.false
        });
        
        it('v8 Case when us zip is not entered correctly', function () {
        ...
        it('v9 Case when all values are filled and form submitted', function (done) {
        ...
        it('v10 Case when all values are filled but form not submitted', function (done) {
            var post = sinon.stub(jQuery, 'ajax');
            post.yieldsTo('success', {"success": true, "postal_code": null, "is_mobile": false});
            $("#new_user #user_first_name").val("archit")
            $("#new_user #user_last_name").val("dugar")
        ...
        it('v11 Case when all values are filled and covering case with no query params', function (done) {
    ...
    describe("Validate Functionality for form New User Pop Up Form", function () {
        ...
        it('v12 Case When Only First Name is there and removed', function () {
        ...
        it('v13 Case When Only Last Name is there and removed', function () {
        ...
        it('v14 Case When Only Email is there and removed', function () {
        ...
        it('v15 Case when all values are filled and form submitted', function (done) {
            var post = sinon.stub($, 'ajax');
            post.yieldsTo('success', [true]);
        ...
        it('v16 Case when all values are filled and something went wrong', function (done) {
            var post = sinon.stub($, 'ajax');
            post.yieldsTo('success', [true]);
            $("#new_user_pop #user_first_name").val("archit")
            $("#new_user_pop #user_last_name").val("dugar")
        ...
        it('v17 Case when all values are filled and form submitted with no query params in the action string', function (done) {
            var post = sinon.stub($, 'ajax');
            console.log("v17")
            post.yieldsTo('success', [true]);
