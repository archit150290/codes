...
function datafetched(formId) {
    FB.api('/me', {fields: "email, first_name, last_name"}, function (response) {
        ...
        objValidateAutoPop.status = true;
        ...
        for (tmp in formarray) {
            ...
            }else if (formId == "new_user_auto_pop") {
                objValidateAutoPop.applyValidation(formarray[tmp]);
            }
        ...
        if (formId == "new_user") {
            ...
            var setIntervalformAutoPop = setInterval(function () {
                if (uniqueness_checked == 1 && objValidateAutoPop.status == true && emailPerfect == true) {
                    clearInterval(setIntervalformAutoPop);
                    $("#" + formId + " .submit").trigger("click");
