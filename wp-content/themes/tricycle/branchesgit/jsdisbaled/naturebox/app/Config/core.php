 ...
 */
Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoasd#@$%UubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
Configure::write('Security.cipherSeed', '76859309657434234553542496749683645');
...
Cache::config('nature', array(
    'engine' => 'File', //[required]
    'duration' => 600, //[optional]
    'probability' => 100, //[optional]
    'path' => CACHE, //[optional] use system tmp directory - remember to use absolute path
    'prefix' => 'nature_', //[optional]  prefix every cache file with this string
