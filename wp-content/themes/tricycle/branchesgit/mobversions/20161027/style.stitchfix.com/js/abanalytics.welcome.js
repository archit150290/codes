        ...
        init: function (config, slot) {
            ...
            if (md.mobile() != null) {
                if (this.utm_medium == "brand") {
                    //=====mobile brand 
                    testConfig = {"home-a": {"min": 1, "max": 95, "variant_id": 0},
                        "home-b": {"min": 96, "max": 100, "variant_id": 1},
                    };
                } else {
                    //=====mobile other 
                    testConfig = {"home-a": {"min": 1, "max": 95, "variant_id": 0},
        ...
        applyHtml: function () {
            switch (this.variantId) {
                ...
                case  1:
                        ...
                        window.location = 'https://style.stitchfix.com/home' + site_q;
                    break;
            }
        }
    };
