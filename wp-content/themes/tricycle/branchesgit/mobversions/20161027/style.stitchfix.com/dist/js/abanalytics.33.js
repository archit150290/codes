    ...
    return {
        ...
        init: function (config, slot) {
            ...
            for (experiment in config) {
                ...
                //var r = Math.random();
                //console.log(r);
                //r = Math.floor(r > 1 ? (r - 1) * 100 :  r * 100);
                var r = Math.floor((Math.random() * 100) + 1)

                // mobile detaction
                if( md.mobile() != null ){
                    testConfig = {"a": {"min": 1, "max": 1, "variant_id": 0}, 
                                  "b": {"min": 2, "max": 2, "variant_id": 1},
                                  "c": {"min": 3, "max": 12, "variant_id": 2},
                                  "d": {"min": 13, "max": 20, "variant_id": 3},
                                  "e": {"min": 21, "max": 60, "variant_id": 4},
                                  "f": {"min": 61, "max": 100, "variant_id": 5}                                                                  
                                };
                }else{
                      testConfig = {"a": {"min": 1, "max": 1, "variant_id": 0}, 
                                  "b": {"min": 2, "max": 2, "variant_id": 1},
                                  "c": {"min": 3, "max": 10, "variant_id": 2},
                                  "d": {"min": 11, "max": 40, "variant_id": 3},
                                  "e": {"min": 41, "max": 60, "variant_id": 4},
                                  "f": {"min": 61, "max": 100, "variant_id": 5}                                                                  
                                };
                }
