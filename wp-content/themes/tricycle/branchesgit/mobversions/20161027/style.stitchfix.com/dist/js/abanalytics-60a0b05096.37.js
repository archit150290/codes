            ...
            if (md.mobile() != null) {
                if (this.utm_medium == "brand") {
                    ...
                    testConfig = {"a": {"min": 0, "max": 0, "variant_id": 0},
                        ...
                        "h": {"min": 0, "max": 0, "variant_id": 7},
                        "i": {"min": 0, "max": 0, "variant_id": 8},
                        "1-2": {"min": 1, "max": 15, "variant_id": 9},
                        "1-3": {"min": 16, "max": 30, "variant_id": 10},
                        "2-2": {"min": 31, "max": 45, "variant_id": 11},
                        "2-3": {"min": 46, "max": 60, "variant_id": 12},
                        "3-2": {"min": 61, "max": 80, "variant_id": 13},
                        "3-3": {"min": 81, "max": 100, "variant_id": 14},
                    };
                }
            } else {
                if (this.utm_medium == "brand") {
