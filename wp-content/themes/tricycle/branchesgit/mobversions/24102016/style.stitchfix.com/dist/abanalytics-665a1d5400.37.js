            ...
            if (md.mobile() != null) {
                if (this.utm_medium == "brand") {
                    ...
                    testConfig = {"a": {"min": 0, "max": 0, "variant_id": 0},
                        ...
                        "f": {"min": 11, "max": 20, "variant_id": 5},
                        "g": {"min": 21, "max": 25, "variant_id": 6},
                        "h": {"min": 26, "max": 30, "variant_id": 7},
                        "i": {"min": 31, "max": 35, "variant_id": 8},
                        "j": {"min": 36, "max": 45, "variant_id": 9},
                        "k": {"min": 46, "max": 55, "variant_id": 10},
                        "l": {"min": 56, "max": 65, "variant_id": 11},
                        "m": {"min": 66, "max": 75, "variant_id": 12},
                        "n": {"min": 76, "max": 85, "variant_id": 13},
                        "o": {"min": 86, "max": 100, "variant_id": 14},
                    };
                } else {
                    //=====mobile other 
                    testConfig = {"a": {"min": 0, "max": 0, "variant_id": 0},
            ...
            switch (this.variantId) {
                ...
                case  9:
                    ABalytics.paintOnLoad(".mob-slider", function () {
                        $("body").addClass("mob-ver ver1-2");
                        mobSliderObj.stagePadding = 95
                        mobSliderObj.autoplayTimeout = 5000;
