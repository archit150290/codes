            ...
            if (md.mobile() != null) {
                if (this.utm_medium == "brand") {
                    ...
                    testConfig = {"a": {"min": 0, "max": 0, "variant_id": 0},
                        ...
                        "d": {"min": 0, "max": 0, "variant_id": 3},
                        "e": {"min": 0, "max": 0, "variant_id": 4},
                        "f": {"min": 1, "max": 20, "variant_id": 5},
                        "g": {"min": 0, "max": 0, "variant_id": 6},
                        "h": {"min": 0, "max": 0, "variant_id": 7},
                        "i": {"min": 0, "max": 0, "variant_id": 8},
                        "j": {"min": 21, "max": 35, "variant_id": 9},
                        "k": {"min": 36, "max": 50, "variant_id": 10},
                        "l": {"min": 51, "max": 65, "variant_id": 11},
                        "m": {"min": 66, "max": 80, "variant_id": 12},
                ...
                if (this.utm_medium == "brand") {
                    ...
                    //=====desktop other 
                    testConfig = {"a": {"min": 1, "max": 100, "variant_id": 0},
                        "b": {"min": 0, "max": 0, "variant_id": 1},
                        "c": {"min": 0, "max": 0, "variant_id": 2},
                        "d": {"min": 0, "max": 0, "variant_id": 3},
                        "e": {"min": 0, "max": 0, "variant_id": 4},
