    ...
    return {
        ...
        init: function (config, slot) {
            ...
            for (experiment in config) {
                ...
                // mobile detaction
                if( md.mobile() != null ){
                    testConfig = {"a": {"min": 1, "max": 15, "variant_id": 0}, 
                                  "b": {"min": 16, "max": 35, "variant_id": 1},
                                  "c": {"min": 36, "max": 43, "variant_id": 2},
                                  "d": {"min": 44, "max": 50, "variant_id": 3},
                                  "e": {"min": 51, "max": 70, "variant_id": 4},
                                  "f": {"min": 71, "max": 100, "variant_id": 5}                                                                  
                                };
                }else{
                      testConfig = {"a": {"min": 1, "max": 15, "variant_id": 0}, 
                                  "b": {"min": 16, "max": 35, "variant_id": 1},
