...
describe('General Test', function () {
    ...
    describe("constructor", function () {
        ...
        it("Test 3 should have 9 variants", function () {
        ...
        it("Test 10 TestConfig Variable should have variants e=10% , f= 30%, g=60% Respectively", function () {
            ...
            expect(testConfig.f).to.have.deep.property('max', 80)
            expect(testConfig.f).to.have.deep.property('variant_id', 5)
            expect(testConfig).to.have.property('g')
            expect(testConfig.g).to.have.deep.property('min', 81)
            expect(testConfig.g).to.have.deep.property('max', 90)
            expect(testConfig.g).to.have.deep.property('variant_id', 6)
            expect(testConfig).to.have.property('h')
            expect(testConfig.h).to.have.deep.property('min', 91)
    ...
    describe("Check Ratios based upon utm_medium", function () {
        ...
        it("Test 28 TestConfig Variable should have variants as given Respectively where utm_medium == brand", function () {
            ...
            expect(testConfig).to.have.property('f')
            expect(testConfig.f).to.have.deep.property('min', 1)
            expect(testConfig.f).to.have.deep.property('max', 75)
            expect(testConfig.f).to.have.deep.property('variant_id', 5)
            expect(testConfig).to.have.property('g')
            expect(testConfig.g).to.have.deep.property('min', 76)
            expect(testConfig.g).to.have.deep.property('max', 85)
            expect(testConfig.g).to.have.deep.property('variant_id', 6)
            expect(testConfig).to.have.property('h')
            expect(testConfig.h).to.have.deep.property('min', 86)
        ...
        it("Test 29 TestConfig Variable should have variants  Respectively where Mobile utm_medium == brand", function () {
            ...
            expect(testConfig.b).to.have.deep.property('max', 5)
            expect(testConfig.b).to.have.deep.property('variant_id', 1)
            expect(testConfig).to.have.property('c')
            expect(testConfig.c).to.have.deep.property('min', 0)
            expect(testConfig.c).to.have.deep.property('max', 0)
            ...
            expect(testConfig.e).to.have.deep.property('variant_id', 4)
            expect(testConfig).to.have.property('f')
            expect(testConfig.f).to.have.deep.property('min', 6)
            expect(testConfig.f).to.have.deep.property('max', 10)
            expect(testConfig.f).to.have.deep.property('variant_id', 5)
            expect(testConfig).to.have.property('g')
            expect(testConfig.g).to.have.deep.property('min', 11)
            expect(testConfig.g).to.have.deep.property('max', 20)
            expect(testConfig.g).to.have.deep.property('variant_id', 6)
            expect(testConfig).to.have.property('h')
            expect(testConfig.h).to.have.deep.property('min', 21)
            expect(testConfig.h).to.have.deep.property('max', 30)
            expect(testConfig.h).to.have.deep.property('variant_id', 7)
            expect(testConfig.i).to.have.deep.property('min', 31)
            expect(testConfig.i).to.have.deep.property('max', 40)
            expect(testConfig.i).to.have.deep.property('variant_id', 8)
            expect(testConfig.j).to.have.deep.property('min', 41)
            expect(testConfig.j).to.have.deep.property('max', 50)
            expect(testConfig.j).to.have.deep.property('variant_id', 9)
            expect(testConfig.k).to.have.deep.property('min', 51)
            expect(testConfig.k).to.have.deep.property('max', 60)
            expect(testConfig.k).to.have.deep.property('variant_id', 10)
            expect(testConfig.l).to.have.deep.property('min', 61)
            expect(testConfig.l).to.have.deep.property('max', 70)
            expect(testConfig.l).to.have.deep.property('variant_id', 11)
            expect(testConfig.m).to.have.deep.property('min', 71)
            expect(testConfig.m).to.have.deep.property('max', 80)
            expect(testConfig.m).to.have.deep.property('variant_id', 12)
            expect(testConfig.n).to.have.deep.property('min', 81)
            expect(testConfig.n).to.have.deep.property('max', 90)
            expect(testConfig.n).to.have.deep.property('variant_id', 13)
            expect(testConfig.o).to.have.deep.property('min', 91)
