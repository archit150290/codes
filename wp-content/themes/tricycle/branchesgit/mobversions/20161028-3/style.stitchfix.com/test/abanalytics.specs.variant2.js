...
describe('General Test', function () {
    describe("constructor", function () {
        ...
        it("Test 4 should have a variant from array['a']", function () {
            expect(['a']).to.include(ABalytics.variantName);
        });
        ...
        it("Test 6 should not have a variant from array['a']", function () {
        ...
        it("Test 10 TestConfig Variable should have variants e=10% , f= 30%, g=60% Respectively", function () {
            ...
            expect(testConfig.a).to.have.deep.property('min', 1)
            expect(testConfig.a).to.have.deep.property('max', 100)
