module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'js/jquery2.1.0.js',
            'js/abanalytics.home2.js',
            'js/owl.carousel.min.js',
            'js/validate.home2.js',
            'js/track.13.js',
            'js/mobile-detect.min.js',
            'test/global.js',
            'test/qa.html',
            'test/amptload.js',
            'test/abanalytics.home2.specs.js',
            'test/validation.home2.specs.js',
        ],
        exclude: [
        ],
        preprocessors: {
            'test/qa.html': ['html2js'],
            'js/abanalytics.home2.js' : 'coverage',
            'js/validate.home2.js' : 'coverage'
        },
