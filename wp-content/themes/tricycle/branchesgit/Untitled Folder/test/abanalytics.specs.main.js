...
describe('General Test', function () {
    describe("constructor", function () {
        ...
        it("Test 4 should have a variant from array['s-banner']", function () {
            expect(['s-banner']).to.include(ABalytics.variantName);
        });
        ...
        it("Test 6 should not have a variant from array['s-banner']", function () {
        ...
        it("Test 10 TestConfig Variable should have variants s-banner=100% Respectively", function () {
            //=====desktop other 
            expect(testConfig).to.have.property('s-banner')
            expect(testConfig['s-banner']).to.have.deep.property('min', 1)
            expect(testConfig['s-banner']).to.have.deep.property('max', 100)
            expect(testConfig['s-banner']).to.have.deep.property('variant_id', 0)
        });
