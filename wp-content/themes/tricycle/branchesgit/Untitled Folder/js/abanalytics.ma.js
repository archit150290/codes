...
var ABalytics = (function (window, document, undefined) {
    ...
    return {
        ...
        init: function (config, slot) {
            ...
            var bannerVariant = ["ma-1-banner", "ma-2-banner", "ma-3-banner", "ma-4-banner"];
            if (md.mobile() != null) {
                if (this.utm_medium == "brand") {
                    testConfig = {"ma-1": {"min": 1, "max": 10, "variant_id": 0},
                        "ma-2": {"min": 11, "max": 30, "variant_id": 1},
                        "ma-3": {"min": 31, "max": 50, "variant_id": 2},
                        "ma-4": {"min": 51, "max": 60, "variant_id": 3},
                        "ma-1-banner": {"min": 61, "max": 70, "variant_id": 4},
                        "ma-2-banner": {"min": 71, "max": 80, "variant_id": 5},
                        "ma-3-banner": {"min": 81, "max": 90, "variant_id": 6},
                        "ma-4-banner": {"min": 91, "max": 100, "variant_id": 7},
                    };
                } else {
                    testConfig = {"ma-1": {"min": 1, "max": 10, "variant_id": 0},
                        "ma-2": {"min": 11, "max": 30, "variant_id": 1},
