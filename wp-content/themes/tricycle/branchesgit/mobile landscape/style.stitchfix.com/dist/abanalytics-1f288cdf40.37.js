            ...
            if (md.mobile() != null) {
                if (this.utm_medium == "brand") {
                    ...
                    testConfig = {"a": {"min": 0, "max": 0, "variant_id": 0},
                        ...
                        "f": {"min": 1, "max": 40, "variant_id": 5},
                        "g": {"min": 0, "max": 0, "variant_id": 6},
                        "h": {"min": 41, "max": 80, "variant_id": 7},
                        "i": {"min": 81, "max": 85, "variant_id": 8},
                        "j": {"min": 86, "max": 90, "variant_id": 9},
                        "k": {"min": 0, "max": 0, "variant_id": 10},
                        "l": {"min": 91, "max": 95, "variant_id": 11},
                        "m": {"min": 0, "max": 0, "variant_id": 12},
                        "n": {"min": 96, "max": 100, "variant_id": 13},
                        "o": {"min": 0, "max": 0, "variant_id": 14},
                        "p": {"min": 0, "max": 0, "variant_id": 15},
                        "q": {"min": 0, "max": 0, "variant_id": 16},
                    };
                } else {
                    //=====mobile other 
                    testConfig = {"a": {"min": 0, "max": 0, "variant_id": 0},
                ...
                if (this.utm_medium == "brand") {
                    ...
                    testConfig = {"a": {"min": 0, "max": 0, "variant_id": 0},
                        ...
                        "d": {"min": 0, "max": 0, "variant_id": 3},
                        "e": {"min": 0, "max": 0, "variant_id": 4},
                        "f": {"min": 1, "max": 50, "variant_id": 5},
                        "g": {"min": 0, "max": 0, "variant_id": 6},
                        "h": {"min": 51, "max": 95, "variant_id": 7},
                    ...
                    testConfig = {"a": {"min": 0, "max": 0, "variant_id": 0},
                        ...
                        "d": {"min": 0, "max": 0, "variant_id": 3},
                        "e": {"min": 0, "max": 0, "variant_id": 4},
                        "f": {"min": 1, "max": 55, "variant_id": 5},
                        "g": {"min": 0, "max": 0, "variant_id": 6},
                        "h": {"min": 56, "max": 100, "variant_id": 7},
                        "i": {"min": 0, "max": 0, "variant_id": 8},
                        "p": {"min": 0, "max": 0, "variant_id": 15},
                        "q": {"min": 0, "max": 0, "variant_id": 16},
                    };
        ...
        applyHtml: function () {
            ...
            switch (this.variantId) {
                ...
                case 9:
                    ...
                    window.location = 'https://style.stitchfix.com/about3' + site_q;
                    break;
                case 11:
                    if (site_q == "") {
                        site_q = "?utm_campaign=" + dfutm_camid + "&utm_source=ampush&utm_medium=other";
                    }
                    window.location = 'https://style.stitchfix.com/about4' + site_q;
                    break;
                case 13:
                    if (site_q == "") {
                        site_q = "?utm_campaign=" + dfutm_camid + "&utm_source=ampush&utm_medium=other";
                    }
                    window.location = 'https://style.stitchfix.com/about5' + site_q;
                    break;
                case 15:
                    if (site_q == "") {
                        site_q = "?utm_campaign=" + dfutm_camid + "&utm_source=ampush&utm_medium=other";
                ...
                case 16:
                    ...
                    window.location = 'https://style.stitchfix.com/home2' + site_q;
                    break;
            }
        }
    };
