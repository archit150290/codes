...
function getViewportOffset($e) {
    var $window = $(window), scrollLeft = $window.scrollLeft(), scrollTop = $window.scrollTop(), offset = $e.offset(),
            ...
            if (md.mobile() != null) {
                if (this.utm_medium == "brand") {
                    ...
                    testConfig = {"a": {"min": 0, "max": 0, "variant_id": 0},
                        ...
                        "f": {"min": 0, "max": 0, "variant_id": 5},
                        "g": {"min": 0, "max": 0, "variant_id": 6},
                        "h": {"min": 0, "max": 0, "variant_id": 7},
                        "i": {"min": 0, "max": 0, "variant_id": 8},
                        "j": {"min": 1, "max": 15, "variant_id": 9},
                        "k": {"min": 16, "max": 30, "variant_id": 10},
                        "l": {"min": 31, "max": 45, "variant_id": 11},
                        "m": {"min": 46, "max": 60, "variant_id": 12},
                        "n": {"min": 61, "max": 80, "variant_id": 13},
                        "o": {"min": 81, "max": 100, "variant_id": 14},
                    };
                } else {
                    //=====mobile other 
                    testConfig = {"a": {"min": 0, "max": 0, "variant_id": 0},
