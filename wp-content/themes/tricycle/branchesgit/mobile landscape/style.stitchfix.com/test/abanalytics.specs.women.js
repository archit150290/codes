...
describe('General Test', function () {
    describe("constructor", function () {
        before(function () {
            ...
            if (window.__html__) {
                document.body.innerHTML = window.__html__['test/qa.variant2.html'];
            }
        ...
        it("Test 4 should have a variant from array['women-a']", function () {
            expect(['women-a']).to.include(ABalytics.variantName);
        });
        ...
        it("Test 6 should not have a variant from array['women-a']", function () {
        ...
        it("Test 10 TestConfig Variable should have variants women-a=100% Respectively", function () {
            //=====desktop other 
            expect(testConfig).to.have.property('women-a')
            expect(testConfig['women-a']).to.have.deep.property('min', 1)
            expect(testConfig['women-a']).to.have.deep.property('max', 100)
            expect(testConfig['women-a']).to.have.deep.property('variant_id', 0)
        });
