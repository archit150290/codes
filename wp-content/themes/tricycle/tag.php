                    ...
                    <article class ='<?php echo $post_type; ?>' >
                        ...
                        <section class = 'titles'>
                            ...
                            <p><?php
                                ...
                                ?></p>  <?php if($post_type!= EBOOKS_POST_TYPE) // as we dont need author and time for ebooks
                            {?>
                ...
                while (have_posts()) {
                    ...
                    <div id="loadingimage" style="position:relative"></div>
                        <div class='more'>
                            ...
                            <input type="hidden" name="taxonomy" id="taxonomy" value="<?php echo 'post_tag' ?>" />
                            <input type="hidden" name="taxname" id="taxname" value="<?php echo $current_tag; ?>" />
