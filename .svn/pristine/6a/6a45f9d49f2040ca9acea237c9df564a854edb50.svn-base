...
while(have_posts())
{
    ...
    if($layout == "hero")
    {
        ...
        <div class='hero'>
            <figure>
                <?php echo get_image_with_srcset(array("post_id"=>get_the_ID(), "image_type"=>"hero_template_image", "source_width"=>array(2001, 1001, 501), "size"=>"image-size-20000", "attr_sizes"=>"100vw")); ?>
                    ...
                    <main class='article-main_<?php echo $layout; ?>'>
                        <div class='article-image_featured'>
                            <figure>
                                ...
                                <?php echo get_image_with_srcset(array("post_id"=>get_the_ID(), "image_type"=>"base_template_image", "source_width"=>array(2001, 1001, 501), "size"=>"image-size-20000", "attr_sizes"=>"(min-width: 60em) 66vw, 100vw")); ?>
...
<script type="text/javascript">
    ...
    jQuery(function(){
        if(no_comment == 0)
        {
            jQuery("#disqus_thread").css("height", "360px");
        }
    });            
</script>
<!-- start footer -->
