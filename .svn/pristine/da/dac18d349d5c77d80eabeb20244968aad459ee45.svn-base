...
<div class="row row-padding" id="usersdetail">
    <div class="col-md-4">
    <?php
            echo '<span class="pull-left" style="margin-right:15px;">'.$this->Html->image('sub-org.png',array('class'=>"img-circle",  'width'=>'61','height'=>'61')).'</span>'; 
    ?>
        <h6 class="user"><?php echo ucfirst($entity['Entity']['name']);?></h6>
    </div>
