        ...
        <main class='wrap_base'>
            ...
            while (have_posts()) : the_post();
                ...
                <article class='article_base filmfestival'>
                    ...
                    <main class='article-main_film'>
                        ...
                        <?php
                        $IslatestPost =  is_latest_post($postId,'',FILM_FESTIVAL_POST_TYPE);
			
			/*if($IslatestPost){
				
                               $video_data = get_post_meta($postId ,'meta_type_filmfest_video1',true);
                        }else{
                               $video_data = get_post_meta($postId ,'meta_type_filmfest_shorttrailer',true);	
                        }*/
			...
			$video_data = "";
				...
				$directorname =  strip_tags(getAuthorDetail(get_the_ID(),0,0));
                                ...
                                if($filmfestcountry){
                                    echo "Country:".$filmfestcountry."<br />";
                                }
                                if(get_post_meta($postId, 'filmyear_metabox', true)){
                                    echo "Year:".$filmfestyear;
                                }?>
                                </p>
				<?php $posttrailer = get_post_meta(get_the_ID(), 'meta_type_filmfest_shorttrailer', true); ?>
                                ...
                                <div class='modal-inner_video'>
                                    ...
                                    <div class="video">
                                        <div class="video-wrapper">
                                             <?php echo $trailerVideo = get_post_meta(get_the_ID(), 'meta_type_filmfest_shorttrailer', true); ?>
                ...
                <aside>
                    <script type='text/javascript'>
                        googletag.cmd.push(function() {
                            googletag.defineSlot('/52618277/trike_filmfestival_sidebar_300x250', [300, 250], 'div-gpt-ad-1455075672582-2').addService(googletag.pubads());
