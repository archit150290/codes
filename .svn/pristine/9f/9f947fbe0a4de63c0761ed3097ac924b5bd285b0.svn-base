...
class UsersController extends AppController {
    ...
    public function beforeFilter() {
        ...
        $this->Auth->allow('register', 'login', 'logout', 'forgot', 'createclient', 'setImage', 'deleteimage', 'usersfaq', 'test', 'setOrgImage', 'deleteorgimage', "forgotPassword", "setPassword",'unsubscribe');
    }
