					...
					<!-- <div class='more ebooks'>
						<a class='button' href='#'>Download</a>
                                        ...
                                        <?php
                                                ...
                                                $bookpermalink = get_post_field('post_name', get_the_ID());
							...
							{   
								...
								<div class='dropdown more ebooks'>
								  <div class='dropdown-container'>
									...
									<?php if($downloadEPUB!=""){ ?>
                                                                        <li><a onClick="ga('send', 'event', { eventCategory: 'ebook', eventAction: 'download', eventLabel: '<?php echo $bookpermalink;?>'});" target="_blank" href='<?php echo get_site_url(); ?>/download.php?file=<?php echo urlencode(base64_encode($downloadEPUB)); ?>'>epub</a></li>
									<?php } ?>
									<?php if($downloadMOBI!=""){ ?>
									    <li><a onClick="ga('send', 'event', { eventCategory: 'ebook', eventAction: 'mobi', eventLabel: '<?php echo $bookpermalink;?>'});" target="_blank" href='<?php echo get_site_url(); ?>/download.php?file=<?php echo urlencode(base64_encode($downloadMOBI)); ?>'>mobi</a></li>
                                                                        <?php } ?>
                                                                        <?php if($downloadPDF!=""){ ?>
                                                                              <li><a onClick="ga('send', 'event', { eventCategory: 'ebook', eventAction: 'pdf', eventLabel: '<?php echo $bookpermalink;?>'});" target="_blank" href='<?php echo get_site_url(); ?>/download.php?file=<?php echo urlencode(base64_encode($downloadPDF)); ?>'>pdf</a></li>
                                                                        <?php } ?>
