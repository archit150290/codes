...
<div class='wrap'>
	...
	<header class='rubric_top'>
        ...
        <main>
            ...
            if (have_posts() && $results) {
                while (have_posts()) {
                    the_post();
                    $post_date = get_the_date("Y");
                    if(!in_array($post_date, $results))
                    {
                        continue;
                    }
                    $postId[] = get_the_ID();
                    ...
                    <article class='filmfestival'>
                        <section class='titles'>
                            ...
                            <address><a href='<?php the_permalink(); ?>'>
                            <?php echo strip_tags(getAuthorDetail(get_the_ID(),0,0)); ?>
                            </a>
                            </address>
                        </section>
                        <figure>
