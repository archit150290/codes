...
<div class='wrap'> 
    ...
    <div class='landing-stack'>
        <div class='landing-stack-1'>
            <?php
            if (have_posts()) {
                //to calculate the no of post available........
                $counter = 1;
                while (have_posts() && $countPosts > 0) {
                    $countPosts--;
                    the_post();
                    $post_type = get_post_type();
                    $postValues = get_post_type_object($post_type);
                    ...
                    <?php if ($counter == 7 && $countPosts > 0) {
                        ...
                        <div class="loader-more">
                            ...
                            <div class='more'>
                                ...
                                <input type="hidden" name="taxonomy" id="taxonomy" value="<?php echo 'category' ?>" />
