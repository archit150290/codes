...
<div class="row row-padding" id="usersdetail">
    ...
    ?>
        <h6 class="user"><?php echo ucfirst($jobTitle['OrgJobTitle']['title']);?></h6>
    </div>
                ...
                <?php /*<li><a href="#"><img src="<?php echo $this->webroot; ?>img/search_map-white.png" alt="" /></a></li> */?>
                                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="<?php echo $this->webroot; ?>img/pancake-white.png" alt="" /> </a>
                                    <ul class="dropdown-menu">
                                      <li><a href="#"><?php // echo $this->Html->link(__('Save as Spreadsheet'), array('controller' => 'organizations', 'action' => 'export', '?' => array('orgid' => $organizationId, 'userid' => $user_id, 'information' => 'endorser')));?></a></li>
<!--                                        <li><a href="javascript:void(0)" id="endorsementsreceivedsas" class="endorsementssas" data-userid = "<?php echo $user_id;?>" data-information = "endorser">Save As Spreadsheet</a></li>-->
                                      <li><a href="javascript:void(0)" onclick="saveallendorsement('js_endorsementGiven', <?php echo $organizationId;?>, 'allendorsements', 'endorser')">Save as Spreadsheet</a></li>
    ...
    <div class="row">
        <div class="col-md-12" id="listingreportseg">
            <div class="row">
                ...
                <div class="col-md-4">
          <?php
//                                echo $this->Html->link(__('Export'), array('controller' => 'organizations', 'action' => 'export', '?' => array('orgid' => $organizationId, 'userid' => $user_id, 'information' => 'endorsed')));
//                                
...
<!--                                        <li><a href="javascript:void(0)" id="endorsementsreceivedsas" class="endorsementssas" data-deptid = "<?php echo $department['OrgDepartment']['id'];?>" data-information = "endorsed">Save As Spreadsheet</a></li>-->
                                        <li><a href="javascript:void(0)" onclick="saveallendorsement('js_endorsementReceived', <?php echo $organizationId;?>, 'allendorsements', 'endorsed')">Save as Spreadsheet</a></li>
            ...
            <div data-example-id="striped-table" class="row bs-example">
                ...
                <?php 
                        ...
                        <tbody id="js_endorsementReceived">
              <?php 
