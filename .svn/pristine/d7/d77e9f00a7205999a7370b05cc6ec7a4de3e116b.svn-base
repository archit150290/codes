...
// Add default posts and comments RSS feed links to head.
    ...
    add_image_size('image-size-2000', 2000);
    add_image_size('image-size-1000', 1000);
    add_image_size('image-size-800', 800);
    add_image_size('image-size-500', 500);
        ...
        while ($eq_query->have_posts()): $eq_query->the_post();
            ...
            <?php
                    if($post_type == MAGAZINE_POST_TYPE ||  $post_type == EBOOKS_POST_TYPE)
                    {
                        ...
                        $source_width = array(1000, 500, 400);
                    }else{
        ...
        while ($querydharma->have_posts()):
            ...
            <div class='social-wrap'>
                <ul class='dailydharma-social'>
                    <li class="st_facebook_custom" st_title='<?php the_content(); ?>' st_url='<?php if (empty($dailydharma_url)) {
            the_permalink();
            } else {
                echo $dailydharma_url;
                                ...
                                <li class="st_twitter_custom" st_title='<?php the_content(); ?>' st_url='<?php if (empty($dailydharma_url)) {
                    the_permalink();
                } else {
                    echo $dailydharma_url;
                                ...
                                <li class="st_email_custom" st_title='<?php the_content(); ?>' st_url='<?php if (empty($dailydharma_url)) {
                    the_permalink();
                } else {
                    echo $dailydharma_url;
